...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo" style="width: 250px;">特定园区自动驾驶管理系统</a>
            <!-- 显示/隐藏菜单 icon-caidan -->
...
<%--                </li>--%>
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${yeqifu}/static/images/yunle.png" class="layui-nav-img userAvatar"
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${yeqifu}/static/images/yunle.png" class="userAvatar"></a>
            <p>欢迎来到云乐！</p>
        </div>
        <!-- 搜索 -->
