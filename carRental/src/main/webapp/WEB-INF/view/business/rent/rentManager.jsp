        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="rentid" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入车辆订单号" style="height: 30px;border-radius: 10px">
            </div>
        </div>
<%--        <div class="layui-inline">--%>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="carnumber" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入车辆ID" style="height: 30px;border-radius: 10px">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="startTime" id="startTime" readonly="readonly"
                       ...
                       placeholder="请输入订单开始时间" style="height: 30px;border-radius: 10px">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="endTime" id="endTime" readonly="readonly"
                       class="layui-input layui-input-inline"
                       placeholder="请输入订单结束时间" style="height: 30px;border-radius: 10px">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">订单状态:</label>
            <div class="layui-input-inline">
                <input type="radio" name="rentflag" value="1" title="已完成">
                <input type="radio" name="rentflag" value="0" title="未完成">
            </div>
            <button type="button"
...
<script type="text/html" id="rentBar">
    {{#  if(d.rentflag == 1){ }}
    <a class="layui-btn layui-btn-green layui-btn-xs layui-btn-radius" lay-event="exportRent">导出订单</a>
    {{#  } else { }}
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="rentid" lay-verify="required" readonly="readonly" placeholder="请输入订单号"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">开始时间:</label>
                <div class="layui-input-inline">
                    <input type="text" name="begindate" id="begindate" readonly="readonly" lay-verify="required" placeholder="请输入开始时间" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">结束时间:</label>
                <div class="layui-input-inline">
                    <input type="text" name="returndate" id="returndate" readonly="readonly" lay-verify="required" placeholder="请输入结束时间" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , title: '订单数据表'//数据导出来的标题
            , toolbar: "#rentToolBar"   //表格的工具条
            , height: 'full-210'
            , cellMinWidth: 80 //设置列的最小默认宽度
            , page: true  //是否启用分页
            , cols: [[   //列表数据
                , {field: 'rentid', title: '订单号', align: 'center', width: '252'}
                , {field: 'phone', title: '手机号', align: 'center', width: '120'}
                , {field: 'carnumber', title: '车辆ID', align: 'center', width: '105'}
                // , {field: 'price', title: '出租价格', align: 'center', width: '90'}
                , {
                    field: 'rentflag', title: '完成状态', align: 'center', width: '100', templet: function (d) {
                        return d.rentflag == '1' ? '<font color=blue>已完成</font>' : '<font color=red>未完成</font>';
                    }
                }
                , {field: 'begindate', title: '开始时间', align: 'center', width: '170'}
                , {field: 'returndate', title: '结束时间', align: 'center', width: '170'}
        ...
        table.on('tool(rentTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rentid + '】这个订单么？', function (index) {
                    //向服务端发送删除指令
