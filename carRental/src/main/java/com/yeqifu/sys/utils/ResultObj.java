...
public class ResultObj {
     ...
     * 更新失败, 手机号用户不存在
     */
    public static final ResultObj UPDATE_ERROR_NO_PHONE = new ResultObj(SysConstast.CODE_ERROR,SysConstast.UPDATE_ERROR_NO_PHONE);
    /**
     * 租车失败, 手机号用户不存在
     */
    public static final ResultObj RENT_ERROR_NO_PHONE = new ResultObj(SysConstast.CODE_ERROR,SysConstast.RENT_ERROR_NO_PHONE);
    /**
     * 删除成功
     */
