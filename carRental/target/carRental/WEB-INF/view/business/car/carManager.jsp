...
<%--        </div>--%>
        <div class="layui-inline">
            <label class="layui-form-label">是否派出:</label>
            <div class="layui-input-inline">
                <input type="radio" name="isrenting" value="1" title="已派出">
                <input type="radio" name="isrenting" value="0" title="未派出">
            </div>
            <button type="button"
...
<%--                               placeholder="请输入车辆派出价格" style="height: 30px;border-radius: 10px">--%>
<%--                    </div>--%>
<%--                </div>--%>
<%--            </div>--%>
            <div class="layui-form-item magb0">
<%--                <div class="layui-inline">--%>
<%--                    <label class="layui-form-label">派出押金:</label>--%>
<%--                    <div class="layui-input-block" style="padding: 5px">--%>
<%--                        <input type="text" name="deposit" class="layui-input" lay-verify="required|number"--%>
<%--                               placeholder="请输入车辆派出押金" style="height: 30px;border-radius: 10px">--%>
<%--                    </div>--%>
<%--                </div>--%>
                <div class="layui-inline">
                    <label class="layui-form-label">是否派出:</label>
                    <div class="layui-input-inline">
                        <input type="radio" name="isrenting" value="1" title="已派出">
                        <input type="radio" name="isrenting" value="0" checked="checked" title="未派出">
                    </div>
                </div>
            </div>
            <div class="layui-form-item magb0">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'upload'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                // , {field: 'rentprice', title: '租金/', align: 'center', width: '90'}
                // , {field: 'deposit', title: '派出押金', align: 'center', width: '90'}
                , {
                    field: 'isrenting', title: '派出状态', align: 'center', templet: function (d) {
        ...
        function openAddCar() {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $("#dataFrm")[0].reset();
                    //设置默认图片
                    $("#showCarImg").attr("src", "${yeqifu}/file/downloadShowFile.action?path=defaultcarimage.jpg");
